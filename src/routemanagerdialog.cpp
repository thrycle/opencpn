...
enum { rmVISIBLE = 0, rmROUTENAME, rmROUTEDESC, rmROUTETYPE, rmROUTEDEPTH };// RMColumns;
...
void RouteManagerDialog::Create()
{
    ...
    m_pRouteListCtrl->InsertColumn( rmROUTETYPE, _("Type"), wxLIST_FORMAT_LEFT, 10 * char_width );
    m_pRouteListCtrl->InsertColumn( rmROUTEDEPTH, _("Contain Depth data"), wxLIST_FORMAT_LEFT, 20 * char_width );
    ...
    btnRteSave2Datebase = new wxButton( winr, -1, _("&Save2Datebase") );
    bsRouteButtonsInner->Add( btnRteSave2Datebase, 0, wxALL | wxEXPAND, DIALOG_MARGIN );
    ...
    // track save button
    btnTrkSave2Datebase = new wxButton( wint, -1, _("&Save2Datebase") );
    bsTrkButtonsInner->Add( btnTrkSave2Datebase, 0, wxALL | wxEXPAND, DIALOG_MARGIN );
...
void RouteManagerDialog::UpdateRouteListCtrl()
{
    ...
    for( it = ( *pRouteList ).begin(); it != ( *pRouteList ).end(); ++it, ++index ) {
        ...
        // editor by zch
        wxString type = ( *it )->m_RouteTypeString;
        m_pRouteListCtrl->SetItem( idx, rmROUTETYPE, type );

        bool pointdepth = ( *it )->m_RoutePointDepthFlag;
        if( pointdepth )
            m_pRouteListCtrl->SetItem( idx, rmROUTEDEPTH, _("ok"));
        else
            m_pRouteListCtrl->SetItem( idx, rmROUTEDEPTH, _("--"));
...
void RouteManagerDialog::UpdateRteButtons()
{
    ...
    btnRteSave2Datebase->Enable(enablemultiple);
...
void RouteManagerDialog::UpdateTrkButtons()
{
    ...
    btnTrkSave2Datebase->Enable(items >= 1);
}
...
BEGIN_EVENT_TABLE(tcpDialog, wxFrame)
    EVT_TIMER(TIMER_ID, tcpDialog::OnTimer)
    EVT_CLOSE(tcpDialog::OnQuit)
    EVT_SOCKET(SOCKET_ID, tcpDialog::OnSocketEvent)
    EVT_BUTTON(wxID_OK, tcpDialog::OnConnectToServer)
    EVT_BUTTON(wxID_BACKWARD, tcpDialog::OnQuit)
END_EVENT_TABLE()

tcpDialog::tcpDialog() : wxFrame(NULL, wxID_ANY, _("预警通讯模块"),
                             wxDefaultPosition, wxSize(580, 364))
{
    m_addr_flag = false;
    // Make menus
	...
	bSizer2->Add( m_textCtrl1, 4, wxALL|wxEXPAND, 5 );
	m_textCtrl1->AppendText(wxT("\t\t\t算法数据输出模块\n"));

	m_panel1 = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer4;
	bSizer4 = new wxBoxSizer( wxVERTICAL );

	m_staticText2 = new wxStaticText( m_panel1, wxID_ANY, wxT("本船状态"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText2->Wrap( -1 );
	m_staticText2->SetFont( wxFont( 11, 74, 90, 92, false, wxT("楷体") ) );

	bSizer4->Add( m_staticText2, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );

	wxGridSizer* gSizer1;
	gSizer1 = new wxGridSizer( 2, 2, 0, 0 );

	m_staticText4 = new wxStaticText( m_panel1, wxID_ANY, wxT("安全"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText4->Wrap( -1 );
	gSizer1->Add( m_staticText4, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_bitmap1 = new wxStaticBitmap( m_panel1, wxID_ANY, wxBitmap( wxT("green.jpg"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_bitmap1, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_staticText7 = new wxStaticText( m_panel1, wxID_ANY, wxT("可能危险"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText7->Wrap( -1 );
	gSizer1->Add( m_staticText7, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_bitmap2 = new wxStaticBitmap( m_panel1, wxID_ANY, wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_bitmap2, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_staticText9 = new wxStaticText( m_panel1, wxID_ANY, wxT("危险"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText9->Wrap( -1 );
	gSizer1->Add( m_staticText9, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_bitmap3 = new wxStaticBitmap( m_panel1, wxID_ANY, wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_bitmap3, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_staticText8 = new wxStaticText( m_panel1, wxID_ANY, wxT("建议操纵"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText8->Wrap( -1 );
	gSizer1->Add( m_staticText8, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_staticText10 = new wxStaticText( m_panel1, wxID_ANY, wxT("直航"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText10->Wrap( -1 );
	gSizer1->Add( m_staticText10, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer2->Add( m_panel1, 2, wxEXPAND | wxALL, 5 );

	bSizer1->Add( bSizer2, 6, wxEXPAND, 5 );

	wxBoxSizer* bSizer3;
	bSizer3 = new wxBoxSizer( wxHORIZONTAL );

	m_button1 = new wxButton( this, wxID_OK, wxT("开启端口"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer3->Add( m_button1, 1, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );


	bSizer3->Add( 0, 0, 3, wxEXPAND, 5 );

	m_button2 = new wxButton( this, wxID_ANY, wxT("定时发送"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer3->Add( m_button2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );

	m_button3 = new wxButton( this, wxID_BACKWARD, wxT("返回"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer3->Add( m_button3, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	bSizer1->Add( bSizer3, 1, wxEXPAND|wxALIGN_RIGHT, 5 );
    ...
    m_statusBar->SetStatusText(wxT("Ship state normal"), 0);

    this->Layout();

    m_button2->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(tcpDialog::SetTimerOn), NULL, this);
...
tcpDialog::~tcpDialog()
{
    m_button2->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(tcpDialog::SetTimerOn), NULL, this);
    m_timer.Stop();
}

// event handlers
void tcpDialog::SetTimerOn(wxCommandEvent& event)
{
    if(m_button2->GetLabel() == wxT("定时发送"))
    {
        m_timer.Start(6000); //开始定时计数，定时时间是1s，也就是每秒调用一次OnTimer
        //获取当前时间
        wxDateTime time = wxDateTime::Now();
        wxString title;
        title.Printf("\n%.4i/%.2i/%.2i-%i:%.2i:%.2i:", time.GetYear(), time.GetMonth(), time.GetDay(),time.GetHour(), time.GetMinute(), time.GetSecond());
        m_textCtrl1->AppendText(title);
        m_button2->SetLabel(wxT("中断发送"));
    }
    else
    {
        m_timer.Stop();
        m_button2->SetLabel(wxT("定时发送"));
        m_bitmap1->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
    m_bitmap2->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
    m_bitmap3->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
    m_staticText10->SetLabel(wxT("通信未连接"));
    }
}

void tcpDialog::SetTimerStop(wxCommandEvent& event)
{
    m_timer.Stop();

}

void tcpDialog::OnTimer(wxTimerEvent& event)
{
    ...
    if (Socket && Socket->IsConnected())
    {
        ...
        if ( !g_pAIS )
        {
            m_textCtrl1->AppendText(wxT("未知错误！请联系zhouchenghao@whut.edu.cn"));
        }
        ...
        for ( it = ( *current_targets ).begin(); it != ( *current_targets ).end(); ++it )
        {
            ...
            if( td ) {
                ...
                //m_textCtrl1->AppendText(_("\n"));
                data += wxString::Format(wxT("$!NDAR:%i-"),td->MMSI)
                                +wxString::Format(wxT("%f-"),td->Lon)
                                +wxString::Format(wxT("%f-"),td->Lat)
                                +wxString::Format(wxT("%f-"),((td->SOG)*1852/3600))
                                +wxString::Format(wxT("%f\r\n"),td->COG);
            }
        }
        strcpy(buf, (const char*)data.mb_str(wxConvUTF8));
        Socket->Write(buf, strlen(buf));
        //sock->Write(buf, sizeof(buf));
        memset(buf,'\0',sizeof(buf));
        m_textCtrl1->AppendText(wxT("数据已发送，等待主机算法模块响应...\n"));
    }
    else if(Socket->IsDisconnected() && m_addr_flag)
    {
        //m_addr_flag = false;
...
void tcpDialog::OnQuit(wxCloseEvent& event)
{
    #ifdef __WXGTK__
    gFrame->Raise();
    #endif
...
void tcpDialog::OnQuit(wxCommandEvent& event)
{
    #ifdef __WXGTK__
    gFrame->Raise();
    #endif
...
void tcpDialog::OnConnectToServer(wxCommandEvent& WXUNUSED(event))
{
    m_button1->Disable();
...
//    _("localhost"));
    ...
    wxString hostname(_("192.168.196.1"));
...
void tcpDialog::OnSocketEvent(wxSocketEvent& event)
{
...
#define RD_BUF_SIZE    4096
    ...
    switch(event.GetSocketEvent())
    {
        ...
        case wxSOCKET_INPUT:
        {
            ...
            while(!done){
                int string_tail = 2;
                size_t string_end = m_sock_buffer.find_first_of("*\r\n"); // detect the potential end of a NMEA string by finding the checkum marker or EOL

                if (string_end == wxString::npos) // No termination characters: continue reading
                    break;

                if (m_sock_buffer[string_end] != '*')
                    string_tail = -1;

                if(string_end < m_sock_buffer.size() - string_tail){
                    string_end += string_tail + 1; // move to the char after the 2 checksum digits, if present
                    if ( string_end == 0 ) //The first character in the buffer is a terminator, skip it to avoid infinite loop
                        string_end = 1;
                    std::string string_line = m_sock_buffer.substr(0,string_end);
                    std::string compare_safty = "-安全";
                    std::string compare_mightdanger = "-可能危险";
                    std::string compare_danger = "-危险";
                    ...
                    //  Hard to catch.....
                    if(string_end > m_sock_buffer.size())
                        m_sock_buffer.clear();
                    else
                        m_sock_buffer = m_sock_buffer.substr(string_end);

                    size_t string_start = string_line.find_last_of("$!"); // detect the potential start of a NMEA string, skipping preceding chars that may look like the start of a string.
                    if(string_start != wxString::npos){
                        string_line = string_line.substr(string_start);
                        string_line += "\r\n";        // Add cr/lf, possibly superfluous

                        bool result_1 = strStr(string_line, compare_safty);
                        bool result_2 = strStr(string_line, compare_mightdanger);
                        bool result_3 = strStr(string_line, compare_danger);
                        if (result_3 == true)
                        {
                            m_bitmap1->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
                            m_bitmap2->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
                            m_bitmap3->SetBitmap( wxBitmap( wxT("red.jpg"), wxBITMAP_TYPE_ANY ));
                            m_staticText10->SetLabel(wxT("变速改向"));

                        }
                        else if (result_2 == true)
                        {
                            m_bitmap1->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
                            m_bitmap2->SetBitmap( wxBitmap( wxT("yellow.jpg"), wxBITMAP_TYPE_ANY ));
                            m_bitmap3->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
                            m_staticText10->SetLabel(wxT("变速改向"));
                        }
                        else if (result_1 == true)
                        {
                            m_bitmap1->SetBitmap( wxBitmap( wxT("green.jpg"), wxBITMAP_TYPE_ANY ));
                            m_bitmap2->SetBitmap( wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
                            m_bitmap3->SetBitmap(wxBitmap( wxT("gray.jpg"), wxBITMAP_TYPE_ANY ));
                            m_staticText10->SetLabel(wxT("直航"));
                        }

                        m_textCtrl1->AppendText(wxString(_("Received from server: ")) + string_line);
                        m_textCtrl1->AppendText(_("\n"));
                    }
                }
                else
        ...
        {
            sock->Destroy();
            //m_textCtrl1->AppendText(_("Connection lost.\n"));
            break;
        }
    }
}
 ...
 *
 */
 bool tcpDialog::strStr(const std::string& haystack, const std::string& needle)
 {
    if(!strstr(haystack.c_str(), needle.c_str())) return false;
    else return true;
 }
