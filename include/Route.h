...
#define RTE_TYPE_0 _T("anxian")
#define RTE_TYPE_1 _T("hangdao_bianjie_1")
#define RTE_TYPE_2 _T("hangdao_bianjie_2")    //_("hangdao_bianjie_2"), _("jinghaoqu"), _("Unset"),
#define RTE_TYPE_3 _T("jinghaoqu")
#define RTE_TYPE_UNSET _T("Unset")
...
public:
      ...
      // editor by zch
      wxString  m_RouteTypeString;
      bool    m_RoutePointDepthFlag = 0;
